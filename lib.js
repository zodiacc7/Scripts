...
var memefi = [
    ...
    {text:"BECOME A CRYPTO BANKER: HOW TO CREATE YOUR OWN LIQUIDITY POOL", Code: "24007"},
    {text:"THOUSANDS $ WON BY REAL PEOPLE ON MEMEFI! LAMBO IS NEXT!", Code: "34510"},
    {text:"WHY NO ONE IS TALKING ABOUT THIS HIDDEN ONLINE JOB (THAT PAYS $50/HR)", Code: ""},
    {text:"HOW THE COMFORT ZONE IS RUINING YOUR LIFE", Code: "49191"}
    ]
